        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div className="flex flex-col items-center text-center p-4 rounded-2xl bg-secondary/40 border border-border/50">
            ...
            {isEditingName ? (
              <form onSubmit={handleRename} className="w-full mt-3 flex items-center gap-2">
                <input
                  ...
                  autoFocus
                  className="flex-1 bg-secondary border border-border rounded-lg px-3 py-1.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                />
                <button
                  type="submit"
                  disabled={isRenaming}
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Group Channel · {group.participants?.length || 0} participants
            </p>
          </div>
                      ...
                      {memberSearchResults.map((user) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="px-2 py-1 rounded bg-primary text-white text-[11px] font-medium hover:bg-primary-hover transition-colors shrink-0"
                          >
                  ...
                  >
                    <div className="flex items-center gap-2.5 min-w-0 pr-2">
                      ...
                      <div className="truncate">
                        ...
                        <p className="text-[11px] text-muted-foreground font-mono truncate">{participant.phone}</p>
                      </div>
                    </div>
